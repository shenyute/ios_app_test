...
- (void)viewDidLoad {
	...
	colorList = [NSArray arrayWithObjects: 
				 ...
				 [NSDictionary dictionaryWithObjectsAndKeys:
				  @"Blue",@"titleValue",
				  [UIColor blueColor],@"colorValue",nil], nil];
	[colorList retain];
	self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]
			initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(changeTitle)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    UIViewController *colorController = [[UIViewController alloc] init];
	colorController.title = [[tableView cellForRowAtIndexPath:indexPath].textLabel text];
	colorController.view = [[UIView alloc] init];
	colorController.view.backgroundColor =
